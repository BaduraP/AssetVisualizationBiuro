...
ttk.Button(room_frame, text="Start Room", command=lambda: None).grid(row=2, column=0, columnspan=2, pady=5)
...
ttk.Button(input_frame, text="Save Desk", command=lambda: None).grid(row=2, column=0, pady=5, sticky='ew')
ttk.Button(input_frame, text="Save Room", command=lambda: None).grid(row=3, column=0, pady=5, sticky='ew')
ttk.Button(input_frame, text="Save All", command=lambda: None).grid(row=4, column=0, pady=5, sticky='ew')
ttk.Button(input_frame, text="Load from XML", command=lambda: None).grid(row=5, column=0, pady=5, sticky='ew')
...
canvas = setup_scrollable_canvas()
